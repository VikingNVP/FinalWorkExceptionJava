package Base.Classes.ParsedData;


import Base.AbstractClasses.ADataParseProcessor;
import Base.MyException.FullNameReadFromDataException;
import Base.MyException.GetDataArrayException;
import Base.MyException.ParsedDataException;
import Base.MyException.ParsedDataToIntegerException;
...
public class CDataParseProcessor extends ADataParseProcessor {
    ...
    public void parsedData(String data) {
        ...
        try {
            for (int i = 0; i < dataArray.length; i++) {
                if (this.dataArray[i].length() == 1)
                    ...
                    try {
                        ...
                        throw new ParsedDataToIntegerException(e.getMessage());
                    }
                else {
                    try {
            ...
            throw new ParsedDataException(e.getMessage());
        }
    }
